...
void EigenExamples() {
  ...
  // Set coordinate values to the vector, different ways.
  ...
  // Access coordinate values of the vector, different ways.
  Vector3f v2 = v1;
  v2.x() = v1.x();
  v2.y() = v1.y();
  v2.z() = v1.z();
  ...
  // Putting together things from the past sections, this normalizes the vector:
  v3 = v1 / v1.norm();
  ...
  // Reset M to a simple matrix to be able to interpret the results of the
  // following section.
  M = 2.0 * Matrix3f::Identity();
